...
namespace Proton
{
    ...
    static class Glfw
    {
        ...
        #region Delegates
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWvkproc();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWerrorfun(int code, [In] [MarshalAs(UnmanagedType.LPStr)] string description);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWwindowposfun(IntPtr window, int x, int y);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWwindowsizefun(IntPtr window, int w, int h);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWwindowclosefun(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWwindowrefreshfun(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWwindowfocusfun(IntPtr window, int got);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWwindowiconifyfun(IntPtr window, int iconify);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWframebuffersizefun(IntPtr window, int w, int h);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWcursorposfun(IntPtr window, double x, double y);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWcursorenterfun(IntPtr window, int entered);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWscrollfun(IntPtr window, double xoffset, double yoffset);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWcharfun(IntPtr window, uint codepoint);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWcharmodsfun(IntPtr window, uint codepoint, int mods);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWdropfun(IntPtr window, int count, [Out] string[] paths);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWmonitorfun(IntPtr window, int ev);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void GLFWjoystickfun(int window, int ev);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate int PFNGLFWINITPROC();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWTERMINATEPROC();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWGETVERSIONPROC(ref int major, ref int minor, ref int rev);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETVERSIONSTRINGPROC();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWerrorfun PFNGLFWSETERRORCALLBACKPROC(GLFWerrorfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETMONITORSPROC(ref int count);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETPRIMARYMONITORPROC();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWGETMONITORPOSPROC(IntPtr monitor, ref int xpos, ref int ypos);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWGETMONITORPHYSICALSIZEPROC(IntPtr monitor, ref int widthMM, ref int heightMM);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETMONITORNAMEPROC(IntPtr monitor);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWmonitorfun PFNGLFWSETMONITORCALLBACKPROC(GLFWmonitorfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETVIDEOMODESPROC(IntPtr monitor, ref int count);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETVIDEOMODEPROC(IntPtr monitor);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETGAMMAPROC(IntPtr monitor, float gamma);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETGAMMARAMPPROC(IntPtr monitor);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETGAMMARAMPPROC(IntPtr monitor, ref GLFWgammaramp ramp);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWDEFAULTWINDOWHINTSPROC();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWWINDOWHINTPROC(int hint, int value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWCREATEWINDOWPROC(int width, int height, [In] [MarshalAs(UnmanagedType.LPStr)] string title, IntPtr monitor, IntPtr share);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWDESTROYWINDOWPROC(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate int PFNGLFWWINDOWSHOULDCLOSEPROC(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETWINDOWSHOULDCLOSEPROC(IntPtr window, int value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETWINDOWTITLEPROC(IntPtr window, [In] [MarshalAs(UnmanagedType.LPStr)] string title);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETWINDOWICONPROC(IntPtr window, int count, ref GLFWimage images);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWGETWINDOWPOSPROC(IntPtr window, ref int xpos, ref int ypos);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETWINDOWPOSPROC(IntPtr window, int xpos, int ypos);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWGETWINDOWSIZEPROC(IntPtr window, ref int width, ref int height);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETWINDOWSIZELIMITSPROC(IntPtr window, int minwidth, int minheight, int maxwidth, int maxheight);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETWINDOWASPECTRATIOPROC(IntPtr window, int numer, int denom);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETWINDOWSIZEPROC(IntPtr window, int width, int height);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWGETFRAMEBUFFERSIZEPROC(IntPtr window, ref int width, ref int height);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWGETWINDOWFRAMESIZEPROC(IntPtr window, ref int left, ref int top, ref int right, ref int bottom);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWICONIFYWINDOWPROC(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWRESTOREWINDOWPROC(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWMAXIMIZEWINDOWPROC(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSHOWWINDOWPROC(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWHIDEWINDOWPROC(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWFOCUSWINDOWPROC(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETWINDOWMONITORPROC(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETWINDOWMONITORPROC(IntPtr window, IntPtr monitor, int xpos, int ypos, int width, int height, int refreshRate);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate int PFNGLFWGETWINDOWATTRIBPROC(IntPtr window, int attrib);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETWINDOWUSERPOINTERPROC(IntPtr window, IntPtr pointer);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETWINDOWUSERPOINTERPROC(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWwindowposfun PFNGLFWSETWINDOWPOSCALLBACKPROC(IntPtr window, GLFWwindowposfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWwindowsizefun PFNGLFWSETWINDOWSIZECALLBACKPROC(IntPtr window, GLFWwindowsizefun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWwindowclosefun PFNGLFWSETWINDOWCLOSECALLBACKPROC(IntPtr window, GLFWwindowclosefun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWwindowrefreshfun PFNGLFWSETWINDOWREFRESHCALLBACKPROC(IntPtr window, GLFWwindowrefreshfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWwindowfocusfun PFNGLFWSETWINDOWFOCUSCALLBACKPROC(IntPtr window, GLFWwindowfocusfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWwindowiconifyfun PFNGLFWSETWINDOWICONIFYCALLBACKPROC(IntPtr window, GLFWwindowiconifyfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWframebuffersizefun PFNGLFWSETFRAMEBUFFERSIZECALLBACKPROC(IntPtr window, GLFWframebuffersizefun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWPOLLEVENTSPROC();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWWAITEVENTSPROC();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWWAITEVENTSTIMEOUTPROC(double timeout);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWPOSTEMPTYEVENTPROC();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate int PFNGLFWGETINPUTMODEPROC(IntPtr window, int mode);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETINPUTMODEPROC(IntPtr window, int mode, int value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETKEYNAMEPROC(int key, int scancode);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate int PFNGLFWGETKEYPROC(IntPtr window, int key);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate int PFNGLFWGETMOUSEBUTTONPROC(IntPtr window, int button);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWGETCURSORPOSPROC(IntPtr window, ref double xpos, ref double ypos);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETCURSORPOSPROC(IntPtr window, double xpos, double ypos);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWCREATECURSORPROC(ref GLFWimage image, int xhot, int yhot);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWCREATESTANDARDCURSORPROC(int shape);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWDESTROYCURSORPROC(IntPtr cursor);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETCURSORPROC(IntPtr window, IntPtr cursor);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWkeyfun PFNGLFWSETKEYCALLBACKPROC(IntPtr window, GLFWkeyfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWcharfun PFNGLFWSETCHARCALLBACKPROC(IntPtr window, GLFWcharfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWcharmodsfun PFNGLFWSETCHARMODSCALLBACKPROC(IntPtr window, GLFWcharmodsfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWmousebuttonfun PFNGLFWSETMOUSEBUTTONCALLBACKPROC(IntPtr window, GLFWmousebuttonfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWcursorposfun PFNGLFWSETCURSORPOSCALLBACKPROC(IntPtr window, GLFWcursorposfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWcursorenterfun PFNGLFWSETCURSORENTERCALLBACKPROC(IntPtr window, GLFWcursorenterfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWscrollfun PFNGLFWSETSCROLLCALLBACKPROC(IntPtr window, GLFWscrollfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWdropfun PFNGLFWSETDROPCALLBACKPROC(IntPtr window, GLFWdropfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate int PFNGLFWJOYSTICKPRESENTPROC(int joy);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETJOYSTICKAXESPROC(int joy, ref int count);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETJOYSTICKBUTTONSPROC(int joy, ref int count);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETJOYSTICKNAMEPROC(int joy);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate GLFWjoystickfun PFNGLFWSETJOYSTICKCALLBACKPROC(GLFWjoystickfun cbfun);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETCLIPBOARDSTRINGPROC(IntPtr window, [In] [MarshalAs(UnmanagedType.LPStr)] string @string);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETCLIPBOARDSTRINGPROC(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate double PFNGLFWGETTIMEPROC();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSETTIMEPROC(double time);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate uint PFNGLFWGETTIMERVALUEPROC();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate uint PFNGLFWGETTIMERFREQUENCYPROC();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWMAKECONTEXTCURRENTPROC(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETCURRENTCONTEXTPROC();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSWAPBUFFERSPROC(IntPtr window);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void PFNGLFWSWAPINTERVALPROC(int interval);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate int PFNGLFWEXTENSIONSUPPORTEDPROC([In] [MarshalAs(UnmanagedType.LPStr)] string extension);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETPROCADDRESSPROC([In] [MarshalAs(UnmanagedType.LPStr)] string procname);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate int PFNGLFWVULKANSUPPORTEDPROC();
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate IntPtr PFNGLFWGETREQUIREDINSTANCEEXTENSIONSPROC(ref uint count);
        #endregion
